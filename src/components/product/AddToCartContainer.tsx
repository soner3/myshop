...
export default function AddToCartContainer({ product }: { product: Product }) {
  ...
  return (
    <div className="mt-5 flex w-full flex-col items-center justify-center gap-5 md:mt-0">
      ...
      <button className="flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-br from-sky-500 to-violet-600 p-2 capitalize text-white duration-300 hover:scale-105 active:scale-95">
